    ...
    if (this.state.error) {
      ...
      return (
        <main
          style={{
            alignItems: 'center',
            background: 'radial-gradient(circle at 50% 35%, rgba(74, 222, 255, .14), transparent 34%), #02060a',
        ...
        >
          <section
            style={{
              border: '1px solid rgba(74,222,255,.35)',
              boxShadow: 'inset 0 0 50px rgba(74,222,255,.05), 0 0 35px rgba(74,222,255,.08)',
              maxWidth: '680px',
              padding: '28px',
              width: '100%',
            }}
